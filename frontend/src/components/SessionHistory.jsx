                        ...
                        sessions.map((session, i) => {
                            ...
                            return (
                                <div key={session.id} className="rounded-xl border overflow-hidden transition-all"
                                    ...
                                    {/* Restore Button — shown for ALL plans including active */}
                                    <div className="px-4 pb-3">
                                        <button
                                            ...
                                            style={{
                                                background: isActive
                                                    ? 'linear-gradient(135deg, rgba(99,102,241,0.05), rgba(124,58,237,0.05))'
                                                    : 'linear-gradient(135deg, rgba(99,102,241,0.1), rgba(124,58,237,0.1))',
                                                borderColor: isActive ? 'rgba(99,102,241,0.15)' : 'rgba(99,102,241,0.3)',
                                        ...
                                        >
                                            {restoringId === session.id ? (
                                                ...
                                                <>
                                                    ...
                                                    {isActive ? 'This Plan is Active' : 'Restore this Plan'}
                                                </>
                                            )}
                                        </button>
                                    </div>
